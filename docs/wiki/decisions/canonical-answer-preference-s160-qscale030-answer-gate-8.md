...
| qtrm_core_off_with_evidence | 5/8 | +0 | +0.000 | 5/8 (0.625) | no-drop |
...
| qtrm_answer_residual_governor_off_with_evidence | 5/8 | +0 | +0.000 | 3/8 (0.375) | no-drop |

## Checks

- Passed: `none`
- Failed: `no_critical_causal_drop, critical_ablations_match_baseline_identity, baseline_does_not_beat_comparison`
- Missing modes: `none`
