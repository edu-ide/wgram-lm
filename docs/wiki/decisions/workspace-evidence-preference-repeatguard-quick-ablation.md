...
- workspace evidence path: `runs/eval/memory_reasoning_quick_workspace_evidence_preference_repeatguard_32tok_s050.jsonl`
...
| qtrm_coda_off_with_evidence | 1/4 | -1 | -0.250 |
...
| abstention | qtrm_coda_off_with_evidence | 1/2 | -1 | -0.500 |
