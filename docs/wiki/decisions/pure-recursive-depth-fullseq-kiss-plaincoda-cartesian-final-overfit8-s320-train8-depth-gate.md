...
- Passed: `deep_core_beats_donor, no_retrieval_or_memoryos_shortcut`
- Failed: `deep_core_does_not_beat_core_off, no_depth_scaling_gain, depth_outputs_identical_across_steps`
- Missing modes: `none`
- Shortcut records: `0`
...
| core_off | qtrm_core_off_no_evidence | 7/8 | 0.875 |
| deepest_core | qtrm_core_steps_8_no_evidence | 7/8 | 0.875 |

## Depth Ladder

| Mode | Hits | Accuracy |
| --- | ---: | ---: |
| qtrm_core_steps_1_no_evidence | 7/8 | 0.875 |
| qtrm_core_steps_2_no_evidence | 7/8 | 0.875 |
| qtrm_core_steps_4_no_evidence | 7/8 | 0.875 |
| qtrm_core_steps_8_no_evidence | 7/8 | 0.875 |
