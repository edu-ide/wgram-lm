...
| --- | ---: | ---: | ---: | ---: | --- |
| qtrm_workspace_off_with_evidence | 5/8 | +0 | +0.000 | 7/8 (0.875) | no-drop |
| qtrm_core_off_with_evidence | 5/8 | +0 | +0.000 | 7/8 (0.875) | no-drop |
...
| qtrm_core_to_text_off_with_evidence | 5/8 | +0 | +0.000 | 7/8 (0.875) | no-drop |
