...
| --- | ---: | ---: | ---: | ---: | --- |
| qtrm_workspace_off_with_evidence | 0/4 | +0 | +0.000 | 2/4 (0.500) | no-drop |
| qtrm_core_off_with_evidence | 0/4 | +0 | +0.000 | 2/4 (0.500) | no-drop |
| qtrm_workspace_memory_off_with_evidence | 0/4 | +0 | +0.000 | 2/4 (0.500) | no-drop |
| qtrm_core_context_off_with_evidence | 0/4 | +0 | +0.000 | 4/4 (1.000) | no-drop, same-output |
| qtrm_evidence_bottleneck_off_with_evidence | 1/4 | -1 | -0.250 | 1/4 (0.250) | no-drop |
