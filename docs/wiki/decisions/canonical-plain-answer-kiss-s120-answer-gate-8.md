...
| Mode | Hits | Accuracy |
| --- | ---: | ---: |
| qtrm_residual_with_evidence | 4/8 | 0.500 |

## Critical Mode Checks

| Mode | Hits | Hit drop | Accuracy drop | Same completions | Gate |
| --- | ---: | ---: | ---: | ---: | --- |
| qtrm_workspace_off_with_evidence | 5/8 | -1 | -0.125 | 6/8 (0.750) | no-drop |
| qtrm_core_off_with_evidence | 5/8 | -1 | -0.125 | 7/8 (0.875) | no-drop |
| qtrm_workspace_memory_off_with_evidence | 4/8 | +0 | +0.000 | 8/8 (1.000) | no-drop, same-output |
| qtrm_core_context_off_with_evidence | 4/8 | +0 | +0.000 | 8/8 (1.000) | no-drop, same-output |
| qtrm_core_to_text_off_with_evidence | 4/8 | +0 | +0.000 | 8/8 (1.000) | no-drop, same-output |
| qtrm_evidence_bottleneck_off_with_evidence | 4/8 | +0 | +0.000 | 8/8 (1.000) | no-drop, same-output |
| qtrm_evidence_span_reader_off_with_evidence | 4/8 | +0 | +0.000 | 8/8 (1.000) | no-drop, same-output |
