...
| --- | ---: | ---: | ---: | ---: | --- |
| qtrm_workspace_off_with_evidence | 5/16 | +8 | +0.500 | 4/16 (0.250) | causal-drop |
| qtrm_core_off_with_evidence | 5/16 | +8 | +0.500 | 4/16 (0.250) | causal-drop |
| qtrm_workspace_memory_off_with_evidence | 5/16 | +8 | +0.500 | 4/16 (0.250) | causal-drop |
...
| qtrm_evidence_span_reader_off_with_evidence | 5/16 | +8 | +0.500 | 4/16 (0.250) | causal-drop |
