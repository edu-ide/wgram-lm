...
- Passed: `depth_outputs_not_all_identical, no_retrieval_or_memoryos_shortcut`
- Failed: `deep_core_does_not_beat_core_off, deep_core_does_not_beat_donor, no_depth_scaling_gain`
- Missing modes: `none`
- Shortcut records: `0`
