...
| Mode | Hits | Accuracy |
| --- | ---: | ---: |
| qtrm_residual_with_evidence | 1/2 | 0.500 |

## Critical Mode Checks

| Mode | Hits | Hit drop | Accuracy drop | Same completions | Gate |
| --- | ---: | ---: | ---: | ---: | --- |
| qtrm_workspace_off_with_evidence | 1/2 | +0 | +0.000 | 2/2 (1.000) | no-drop, same-output |
| qtrm_core_off_with_evidence | 1/2 | +0 | +0.000 | 2/2 (1.000) | no-drop, same-output |
| qtrm_workspace_memory_off_with_evidence | 1/2 | +0 | +0.000 | 2/2 (1.000) | no-drop, same-output |
| qtrm_core_context_off_with_evidence | 1/2 | +0 | +0.000 | 2/2 (1.000) | no-drop, same-output |
| qtrm_evidence_bottleneck_off_with_evidence | 1/2 | +0 | +0.000 | 2/2 (1.000) | no-drop, same-output |
| qtrm_evidence_span_reader_off_with_evidence | 1/2 | +0 | +0.000 | 2/2 (1.000) | no-drop, same-output |
