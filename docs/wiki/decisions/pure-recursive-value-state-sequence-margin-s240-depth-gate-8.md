...
- Passed: `deep_core_beats_core_off, depth_scaling_gain_present, deep_core_beats_transition_state_off, depth_outputs_not_all_identical, no_retrieval_or_memoryos_shortcut`
...
| deepest_core | qtrm_core_steps_8_no_evidence | 2/8 | 0.250 |
| transition_state_off | qtrm_core_steps_8_transition_state_off_no_evidence | 1/8 | 0.125 |
...
| qtrm_core_steps_4_no_evidence | 2/8 | 0.250 |
| qtrm_core_steps_8_no_evidence | 2/8 | 0.250 |

## Depth Output Diversity

- Comparable cases: `8`
- Identical across all depth modes: `4`
- Changed by depth: `4`
...
| hybrid_or_cot | qtrm_core_steps_4_no_evidence | 2/8 | 0.250 |
| hybrid_or_cot | qtrm_core_steps_8_no_evidence | 2/8 | 0.250 |
| hybrid_or_cot | qtrm_core_steps_8_transition_state_off_no_evidence | 1/8 | 0.125 |
