...
| --- | ---: | ---: | ---: | ---: | --- |
| qtrm_workspace_off_with_evidence | 2/4 | +1 | +0.250 | 1/4 (0.250) | causal-drop |
| qtrm_core_off_with_evidence | 3/4 | +0 | +0.000 | 4/4 (1.000) | no-drop, same-output |
| qtrm_workspace_memory_off_with_evidence | 2/4 | +1 | +0.250 | 1/4 (0.250) | causal-drop |
...
| qtrm_evidence_span_reader_off_with_evidence | 2/4 | +1 | +0.250 | 1/4 (0.250) | causal-drop |
