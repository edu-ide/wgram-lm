...
| scripted_qtrm_accuracy | 0.2500 |
| scripted_donor_accuracy | 0.2500 |
| state_off_accuracy | 0.5000 |
...
| --- | ---: | ---: | ---: |
| learned_state_qtrm | 2 | 4 | 0.5000 |
| learned_state_qtrm_state_off | 2 | 4 | 0.5000 |
| scripted_donor_answer_channel | 1 | 4 | 0.2500 |
| scripted_qtrm_answer_channel | 1 | 4 | 0.2500 |
...
- `synthetic-negative-authority-redacted-0102`: expected_RETRIEVE_MEMORY_got_ANSWER; sequence=`ANSWER`
