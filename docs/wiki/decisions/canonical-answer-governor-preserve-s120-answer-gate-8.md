...
| qtrm_answer_residual_governor_off_with_evidence | 4/8 | +1 | +0.125 | 4/8 (0.500) | causal-drop |

## Checks

- Passed: `critical_causal_drop_present`
- Failed: `critical_ablations_match_baseline_identity, baseline_does_not_beat_comparison`
- Missing modes: `none`
