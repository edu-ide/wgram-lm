...
- Passed: `deep_core_beats_core_off, deep_core_beats_donor, depth_scaling_gain_present, deep_core_beats_transition_state_off, depth_outputs_not_all_identical, no_retrieval_or_memoryos_shortcut`
- Failed: `none`
- Missing modes: `none`
- Shortcut records: `0`
...
| hybrid_or_cot | qtrm_core_steps_2_no_evidence | 3/8 | 0.375 |
