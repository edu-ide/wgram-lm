...
| --- | --- | ---: | ---: |
| donor | donor_only_no_evidence | 0/8 | 0.000 |
| core_off | qtrm_core_off_no_evidence | 0/8 | 0.000 |
| deepest_core | qtrm_core_steps_8_no_evidence | 8/8 | 1.000 |

## Depth Ladder

| Mode | Hits | Accuracy |
| --- | ---: | ---: |
| qtrm_core_steps_1_no_evidence | 0/8 | 0.000 |
| qtrm_core_steps_2_no_evidence | 0/8 | 0.000 |
| qtrm_core_steps_4_no_evidence | 8/8 | 1.000 |
| qtrm_core_steps_8_no_evidence | 8/8 | 1.000 |
...
| --- | --- | ---: | ---: |
| hybrid_or_cot | donor_only_no_evidence | 0/8 | 0.000 |
...
| hybrid_or_cot | qtrm_core_steps_4_no_evidence | 8/8 | 1.000 |
| hybrid_or_cot | qtrm_core_steps_8_answer_halt_gate_off_no_evidence | 0/8 | 0.000 |
| hybrid_or_cot | qtrm_core_steps_8_no_evidence | 8/8 | 1.000 |
| hybrid_or_cot | qtrm_core_steps_8_transition_joint_answer_bridge_off_no_evidence | 8/8 | 1.000 |
