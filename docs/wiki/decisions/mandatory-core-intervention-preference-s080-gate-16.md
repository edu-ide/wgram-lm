...
| --- | ---: | ---: | ---: | --- |
| donor_only_with_evidence | 10/16 | +3 | +0.188 | baseline-beats |

## Critical Mode Checks

| Mode | Hits | Hit drop | Accuracy drop | Same completions | Gate |
| --- | ---: | ---: | ---: | ---: | --- |
| qtrm_core_off_with_evidence | 10/16 | +3 | +0.188 | 7/16 (0.438) | causal-drop |
| qtrm_workspace_off_with_evidence | 10/16 | +3 | +0.188 | 7/16 (0.438) | causal-drop |
