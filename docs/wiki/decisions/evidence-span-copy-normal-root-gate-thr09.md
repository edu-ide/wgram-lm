...
| --- | ---: | ---: | ---: | ---: | --- |
| qtrm_workspace_off_with_evidence | 2/4 | +0 | +0.000 | 0/4 (0.000) | no-drop |
| qtrm_core_off_with_evidence | 2/4 | +0 | +0.000 | 4/4 (1.000) | no-drop, same-output |
| qtrm_workspace_memory_off_with_evidence | 2/4 | +0 | +0.000 | 0/4 (0.000) | no-drop |
| qtrm_core_context_off_with_evidence | 2/4 | +0 | +0.000 | 4/4 (1.000) | no-drop, same-output |
| qtrm_evidence_bottleneck_off_with_evidence | 2/4 | +0 | +0.000 | 4/4 (1.000) | no-drop, same-output |
| qtrm_evidence_span_reader_off_with_evidence | 2/4 | +0 | +0.000 | 0/4 (0.000) | no-drop |
