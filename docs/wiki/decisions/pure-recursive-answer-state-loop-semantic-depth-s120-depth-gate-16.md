...
- Passed: `deep_core_beats_core_off, no_retrieval_or_memoryos_shortcut`
- Failed: `deep_core_does_not_beat_donor, no_depth_scaling_gain, depth_outputs_identical_across_steps`
- Missing modes: `none`
- Shortcut records: `0`
...
| deepest_core | qtrm_core_steps_8_no_evidence | 2/16 | 0.125 |

## Depth Ladder

| Mode | Hits | Accuracy |
| --- | ---: | ---: |
| qtrm_core_steps_1_no_evidence | 2/16 | 0.125 |
| qtrm_core_steps_2_no_evidence | 2/16 | 0.125 |
| qtrm_core_steps_4_no_evidence | 2/16 | 0.125 |
| qtrm_core_steps_8_no_evidence | 2/16 | 0.125 |
...
| latent_recurrent | qtrm_core_steps_1_no_evidence | 0/4 | 0.000 |
