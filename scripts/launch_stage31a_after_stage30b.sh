...
RUN="${TS}_PERSIST_STAGE31A_LSCR_SDST_dynamic_depth_seed120"
...
env PYTHONUNBUFFERED=1 QTRM_AIM_REPO=/mnt/sdc1/tripleyoung/qtrm_aim PYTHONPATH=src \
  ...
  --aim-description "Stage31A LoopFormer-style latent shortcut consistency plus SDST state-supervision decay and dynamic recurrent depth" \
