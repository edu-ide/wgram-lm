...
OUT_DIR="${OUT_DIR:-local_eval/qwen35_2b_pure_recursive_transition_joint_dynamic_halt_v3_ouro_terminal_depth_ce_s020_from_tail_s020}"
STEPS="${STEPS:-20}"
LR="${LR:-1.0e-5}"
TERMINAL_DEPTH_CE_WEIGHT="${TERMINAL_DEPTH_CE_WEIGHT:-0.25}"

echo "=== QTRM Ouro terminal-depth CE S020 ==="
echo "config: ${CONFIG}"
