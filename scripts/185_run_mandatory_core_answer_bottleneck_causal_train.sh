...
CONFIG="${CONFIG:-configs/qwen35_2b_4090_mandatory_core_answer_bottleneck_causal_s120.yaml}"
DATA="${DATA:-data/filtered/memory_reasoning_canonical_plain_answer.jsonl}"
INIT_CHECKPOINT="${INIT_CHECKPOINT:-runs/qwen35_2b_4090_mandatory_identity_core_causal_s080/last.pt}"
OUT_DIR="${OUT_DIR:-runs/qwen35_2b_4090_mandatory_core_answer_bottleneck_causal_s120}"
...
echo "============================================================"
echo "Mandatory core answer-bottleneck causal training"
echo "config=$CONFIG"
echo "data=$DATA"
...
OUT="runs/eval/mandatory_core_answer_bottleneck_causal_s120_gate_${MAX_CASES}.jsonl" \
AUDIT_OUT="runs/eval/mandatory_core_answer_bottleneck_causal_s120_gate_${MAX_CASES}_audit.jsonl" \
ROOT_MD="docs/wiki/decisions/mandatory-core-answer-bottleneck-causal-s120-gate-${MAX_CASES}.md" \
ROOT_JSON="docs/wiki/decisions/mandatory-core-answer-bottleneck-causal-s120-gate-${MAX_CASES}-summary.json" \
