...
CONFIG="${CONFIG:-configs/qwen35_2b_4090_lewm_core_world_model_probe_s050.yaml}"
...
OUT_DIR="${OUT_DIR:-runs/qwen35_2b_4090_lewm_core_world_model_probe_s050}"
...
PREFERENCE_EVAL_OUT="${PREFERENCE_EVAL_OUT:-runs/eval/lewm_core_world_model_pair_eval_s050.jsonl}"

echo "============================================================"
echo "LeWM-style core world-model probe"
echo "config=${CONFIG}"
...
CONFIG="$CONFIG" CHECKPOINT="$CHECKPOINT" \
  OUT="${OUT:-runs/eval/memory_reasoning_heldout_expanded_lewm_core_world_model_32tok_trained_s050.jsonl}" \
  AUDIT_OUT="${AUDIT_OUT:-runs/eval/memory_reasoning_heldout_expanded_lewm_core_world_model_32tok_trained_s050_audit.jsonl}" \
  PROOF_MD="${PROOF_MD:-docs/wiki/decisions/lewm-core-world-model-trained-ablation.md}" \
  PROOF_JSON="${PROOF_JSON:-docs/wiki/decisions/lewm-core-world-model-trained-ablation-summary.json}" \
