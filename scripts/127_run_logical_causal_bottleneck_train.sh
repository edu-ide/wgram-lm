...
CONFIG="${CONFIG:-configs/qwen35_2b_4090_logical_causal_bottleneck_s050.yaml}"
...
OUT_DIR="${OUT_DIR:-runs/qwen35_2b_4090_logical_causal_bottleneck_s050}"
...
PREFERENCE_EVAL_OUT="${PREFERENCE_EVAL_OUT:-runs/eval/logical_causal_bottleneck_pair_eval_s050.jsonl}"

echo "============================================================"
echo "Logical-causal evidence bottleneck training"
echo "config=${CONFIG}"
...
CONFIG="$CONFIG" CHECKPOINT="$CHECKPOINT" \
  OUT="${OUT:-runs/eval/memory_reasoning_heldout_expanded_logical_causal_bottleneck_32tok_trained_s050.jsonl}" \
  AUDIT_OUT="${AUDIT_OUT:-runs/eval/memory_reasoning_heldout_expanded_logical_causal_bottleneck_32tok_trained_s050_audit.jsonl}" \
  PROOF_MD="${PROOF_MD:-docs/wiki/decisions/logical-causal-bottleneck-trained-ablation.md}" \
  PROOF_JSON="${PROOF_JSON:-docs/wiki/decisions/logical-causal-bottleneck-trained-ablation-summary.json}" \
