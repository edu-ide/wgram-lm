...
CONFIG="${CONFIG:-configs/qwen35_2b_4090_coreless_workspace_answer_candidate.yaml}"
...
OUT="${OUT:-runs/eval/coreless_workspace_answer_candidate_gate_${MAX_CASES}.jsonl}"
AUDIT_OUT="${AUDIT_OUT:-runs/eval/coreless_workspace_answer_candidate_gate_${MAX_CASES}_audit.jsonl}"
ROOT_MD="${ROOT_MD:-docs/wiki/decisions/coreless-workspace-answer-candidate-gate-${MAX_CASES}.md}"
ROOT_JSON="${ROOT_JSON:-docs/wiki/decisions/coreless-workspace-answer-candidate-gate-${MAX_CASES}-summary.json}"
