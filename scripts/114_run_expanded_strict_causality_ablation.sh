...
OUT="${OUT:-runs/eval/memory_reasoning_heldout_expanded_strict_causality_ablation_32tok_synth_generalization_s050.jsonl}"
...
echo "============================================================"
echo "Expanded strict causality ablation gate"
echo "config=${CONFIG}"
