...
QWEN36_BASELINE_REPORT="${QWEN36_BASELINE_REPORT:-local_eval/m6_qwen36_mtp_proxy_baseline/report.json}"
...
M7_REPORT="${M7_REPORT:-local_eval/m7_qtrm_native_mmlu_pro_eval/report.json}"
