...
OUT="${OUT:-runs/eval/memory_reasoning_heldout_expanded_workspace_core_ablation_32tok_synth_generalization_s050.jsonl}"
...
echo "============================================================"
echo "Expanded workspace/core ablation gate"
echo "config=${CONFIG}"
