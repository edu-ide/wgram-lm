...
INIT_CHECKPOINT="${INIT_CHECKPOINT:-local_eval/qwen35_integrated_partial_unfreeze_l23_s200_20260516/last_core.pt}"
OUT_DIR="${OUT_DIR:-local_eval/qwen35_integrated_healing_l23_langkl_s100_20260516}"
DEVICE="${DEVICE:-cuda}"
...
"${PYTHON}" scripts/362_train_qwen_backbone_qtrm_core_gate.py \
  ...
  --mandatory-core \
  --unfreeze-qwen-layer-indices "${UNFREEZE_QWEN_LAYER_INDICES:-23}" \
