...
# Public W-GRAM name; QTRMConfig remains as the legacy config class for
# compatibility with existing checkpoints, YAML keys, and historical tests.
WGRAMConfig = QTRMConfig
