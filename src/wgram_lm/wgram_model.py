...
# Public W-GRAM alias. The underlying class name is retained for checkpoint and
# config compatibility during the package rename.
WGRAMMultimodalModel = QTRMMultimodalModel
